...
import com.github.d3a.engine.core.util.Constant;
...
public class GeospatialTest {
    ...
    public void testGeospatialFunction() throws EngineServiceRuntimeException {
        ...
        GeospatialScaleEntity targetGeospatialScaleEntity3 = defaultGeospatial.getContinentEntity(Geospatial.GeospatialProperty.ChineseName,"�?);
        ...
        Assert.assertEquals(targetGeospatialScaleEntity3.getChineseName(),"北美�?);
        ...
        GeospatialScaleEntity targetGeospatialScaleEntity5 = defaultGeospatial.getProvinceEntity(Geospatial.GeospatialProperty.ChineseName,"中国","江西�?);
        ...
        Assert.assertEquals(targetGeospatialScaleEntity5.getChineseName(),"江西�?);
        Assert.assertEquals(targetGeospatialScaleEntity5.getEnglishName(),"Jiangxi Sheng");

        List<GeospatialScaleEntity> countryRegionGeospatialScaleEntityList4 = defaultGeospatial.listPrefectureEntities(Geospatial.GeospatialProperty.ChineseName,"中国","江西�?,null);
        ...
        GeospatialScaleEntity targetGeospatialScaleEntity6 = defaultGeospatial.getPrefectureEntity(Geospatial.GeospatialProperty.ChineseName,"中国","江西�?,"宜春�?);
        ...
        Assert.assertEquals(targetGeospatialScaleEntity6.getChineseName(),"宜春�?);
        Assert.assertNull(targetGeospatialScaleEntity6.getEnglishName());

        List<GeospatialScaleEntity> countryRegionGeospatialScaleEntityList5 = defaultGeospatial.listCountyEntities(Geospatial.GeospatialProperty.ChineseName,"中国","江西�?,"宜春�?,null);
        ...
        GeospatialScaleEntity targetGeospatialScaleEntity7 = defaultGeospatial.getCountyEntity(Geospatial.GeospatialProperty.ChineseName,"中国","江西�?,"宜春�?,"袁州�?);
        ...
        Assert.assertEquals(targetGeospatialScaleEntity7.getChineseName(),"袁州�?);
        Assert.assertNull(targetGeospatialScaleEntity7.getEnglishName());

        List<GeospatialScaleEntity> countryRegionGeospatialScaleEntityList6 = defaultGeospatial.listTownshipEntities(Geospatial.GeospatialProperty.ChineseName,"中国","江西�?,"宜春�?,"袁州�?,null);
        ...
        GeospatialScaleEntity targetGeospatialScaleEntity8 = defaultGeospatial.getTownshipEntity(Geospatial.GeospatialProperty.ChineseName,"中国","江西�?,"宜春�?,"袁州�?,"飞剑潭乡");
        ...
        List<GeospatialScaleEntity> countryRegionGeospatialScaleEntityList7 = defaultGeospatial.listVillageEntities(Geospatial.GeospatialProperty.ChineseName,"中国","江西�?,"宜春�?,"袁州�?,"飞剑潭乡",null);
        ...
        GeospatialScaleEntity targetGeospatialScaleEntity9 = defaultGeospatial.getVillageEntity(Geospatial.GeospatialProperty.ChineseName,"中国","江西�?,"宜春�?,"袁州�?,"飞剑潭乡","塘源村委�?);
        ...
        Assert.assertEquals(targetGeospatialScaleEntity9.getChineseName(),"塘源村委�?);
        ...
        Assert.assertEquals(targetGeospatialScaleEntity.getChineseName(),"殊桥村委�?);
