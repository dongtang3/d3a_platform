...
public class AttributesMeasurableTest {
    ...
    public void testAttributesMeasurableFunction() throws EngineServiceRuntimeException {
        ...
        newEntityValue.put("prop12", new String[]{"this is str1","这是字符�?"});
        ...
        for(AttributeValue currentAttributeValue:attributeValueList){
            ...
            //neo4j java driver 内部使用Long 来存�?int类型数据
            ...
            if(attributeName.equals("prop12")){
                ...
                Assert.assertEquals(((String[])currentAttributeValueObj)[1],"这是字符�?");
            }
            ...
            //neo4j java driver 内部使用Long 来存�?Byte类型数据
        ...
        AttributeValue newAddedAttributeValue9 = _queryResultEntity.addAttribute("newStringAttribute","string�?);
        ...
        Assert.assertEquals(newAddedAttributeValue9.getAttributeValue(),"string�?);
        ...
        AttributeValue updatedAttributeValue_pro12 = _queryResultEntity.updateAttribute("prop12",new String[]{"this is str1AA","这是字符�?AA"});
