    ...
    public static void main(String[] args) throws ConfigurationErrorException {
        CommonObjectsMessageHandler commonObjectsMessageHandler = new CommonObjectsMessageHandler() {
            ...
            protected void operateRecord(Object recordKey, CommonObjectsReceivedMessage receivedMessage, long recordOffset) {
                ...
                System.out.println("----------");
                System.out.println("SenderIPÔº?"+ commonObjectsPayloadMetaInfo.getSenderIP());
                System.out.println("SenderIdÔº?"+ commonObjectsPayloadMetaInfo.getSenderId());
                System.out.println("SenderGroupÔº?"+ commonObjectsPayloadMetaInfo.getSenderGroup());
                System.out.println("SenderCategoryÔº?"+ commonObjectsPayloadMetaInfo.getSenderCategory());
                System.out.println("PayloadClassificationÔº?"+ commonObjectsPayloadMetaInfo.getPayloadClassification());
                System.out.println("PayloadProcessorÔº?"+ commonObjectsPayloadMetaInfo.getPayloadProcessor());
                System.out.println("PayloadTypeÔº?"+ commonObjectsPayloadMetaInfo.getPayloadType());
                System.out.println("PayloadTypeDescÔº?"+ commonObjectsPayloadMetaInfo.getPayloadTypeDesc());
                System.out.println("----------");
